...
export default function CustomerSuccessDashboardPage() {
  ...
  const loadDashboardData = useCallback(async () => {
    ...
    try {
      const paidList = await customerService.getPaidOrganizations();
      ...
      const analytics = await customerService.getPortfolioAnalytics(14);
      setData(analytics);
      ...
      const logs = await customerService.getActivities(undefined, 15, customApiKey || undefined);
      setActivities(logs);
