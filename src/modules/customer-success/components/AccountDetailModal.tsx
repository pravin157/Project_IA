...
import { AccountDetailBody, AccountSummary, ActivityLogItem } from '@/types/dashboard';
...
export const AccountDetailModal: React.FC<AccountDetailModalProps> = ({
  ...
  useEffect(() => {
    ...
    Promise.all([
      customerService.getAccountDetail(accountSummary.organizationId, 30, 14, 14, customApiKey),
      customerService.getActivities(accountSummary.organizationId, 20, customApiKey),
    ])
      .then(([data, logs]) => {
        if (!mounted) return;
